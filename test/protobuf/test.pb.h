...
class GetFriendListsResponce :
 ...
 public:
  ...
  virtual ~GetFriendListsResponce();
  ...
  inline GetFriendListsResponce* New() const final {
    return CreateMaybeMessage<GetFriendListsResponce>(nullptr);
  }

  GetFriendListsResponce* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::fixbug::User_Sex User::_internal_se() const {
  return static_cast< ::fixbug::User_Sex >(se_);
}
