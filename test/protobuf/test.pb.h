...
class GetFriendListsResponce;
struct GetFriendListsResponceDefaultTypeInternal;
extern GetFriendListsResponceDefaultTypeInternal _GetFriendListsResponce_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListsResponce* Arena::CreateMaybeMessage<::fixbug::GetFriendListsResponce>(Arena*);
...
class User final :
 ...
 public:
  ...
  // .fixbug.User.Sex se = 3;
  void clear_se();
  ::fixbug::User_Sex se() const;
  void set_se(::fixbug::User_Sex value);
  private:
  ::fixbug::User_Sex _internal_se() const;
  void _internal_set_se(::fixbug::User_Sex value);
  public:
...
class GetFriendListsResponce final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsResponce) */ {
 public:
  inline GetFriendListsResponce() : GetFriendListsResponce(nullptr) {}
  ~GetFriendListsResponce() override;
  explicit PROTOBUF_CONSTEXPR GetFriendListsResponce(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendListsResponce(const GetFriendListsResponce& from);
  GetFriendListsResponce(GetFriendListsResponce&& from) noexcept
    : GetFriendListsResponce() {
    *this = ::std::move(from);
  }

  inline GetFriendListsResponce& operator=(const GetFriendListsResponce& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsResponce& operator=(GetFriendListsResponce&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendListsResponce& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendListsResponce* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsResponce*>(
               &_GetFriendListsResponce_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListsResponce& a, GetFriendListsResponce& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsResponce* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendListsResponce* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendListsResponce* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendListsResponce>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendListsResponce& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetFriendListsResponce& from) {
    GetFriendListsResponce::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsResponce* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsResponce";
  }
  protected:
  explicit GetFriendListsResponce(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsResponce)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::fixbug::GetFriendListsResponce* response,
                       ::google::protobuf::Closure* done);
...
// .fixbug.User.Sex se = 3;
inline void User::clear_se() {
  _impl_.se_ = 0;
}
inline ::fixbug::User_Sex User::_internal_se() const {
  return static_cast< ::fixbug::User_Sex >(_impl_.se_);
}
inline ::fixbug::User_Sex User::se() const {
  // @@protoc_insertion_point(field_get:fixbug.User.se)
  return _internal_se();
}
inline void User::_internal_set_se(::fixbug::User_Sex value) {
  
  _impl_.se_ = value;
}
inline void User::set_se(::fixbug::User_Sex value) {
  _internal_set_se(value);
  // @@protoc_insertion_point(field_set:fixbug.User.se)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsResponce::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool GetFriendListsResponce::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsResponce::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsResponce::_internal_result() const {
  const ::fixbug::ResultCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsResponce::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponce.result)
  return _internal_result();
}
inline void GetFriendListsResponce::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListsResponce.result)
}
inline ::fixbug::ResultCode* GetFriendListsResponce::release_result() {
...
inline ::fixbug::ResultCode* GetFriendListsResponce::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResponce.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsResponce::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsResponce::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponce.result)
  return _msg;
}
inline void GetFriendListsResponce::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.result_;
  }
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResponce.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriendListsResponce::_internal_friend_list_size() const {
  return _impl_.friend_list_.size();
}
inline int GetFriendListsResponce::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListsResponce::clear_friend_list() {
  _impl_.friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListsResponce::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponce.friend_list)
  return _impl_.friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponce::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponce.friend_list)
  return &_impl_.friend_list_;
}
inline const ::fixbug::User& GetFriendListsResponce::_internal_friend_list(int index) const {
  return _impl_.friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponce::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponce.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListsResponce::_internal_add_friend_list() {
  return _impl_.friend_list_.Add();
}
inline ::fixbug::User* GetFriendListsResponce::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponce.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponce::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponce.friend_list)
  return _impl_.friend_list_;
}
