...
PROTOBUF_CONSTEXPR GetFriendListsResponce::GetFriendListsResponce(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.friend_list_)*/{}
  , /*decltype(_impl_.result_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct GetFriendListsResponceDefaultTypeInternal {
  PROTOBUF_CONSTEXPR GetFriendListsResponceDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~GetFriendListsResponceDefaultTypeInternal() {}
  union {
    GetFriendListsResponce _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetFriendListsResponceDefaultTypeInternal _GetFriendListsResponce_default_instance_;
}  // namespace fixbug
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::User, _impl_.se_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponce, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponce, _impl_.friend_list_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 40, -1, -1, sizeof(::fixbug::GetFriendListsResponce)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::fixbug::_GetFriendListsResponce_default_instance_._instance,
};
...
User::User(const User& from)
  ...
  ::memcpy(&_impl_.age_, &from._impl_.age_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.se_) -
    reinterpret_cast<char*>(&_impl_.age_)) + sizeof(_impl_.se_));
...
// @@protoc_insertion_point(message_clear_start:fixbug.User)
  ...
  ::memset(&_impl_.age_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.se_) -
      reinterpret_cast<char*>(&_impl_.age_)) + sizeof(_impl_.se_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.User)
  ...
  if (this->_internal_se() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_se());
  }
...
void User::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_se() != 0) {
    _this->_internal_set_se(from._internal_se());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void User::InternalSwap(User* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(User, _impl_.se_)
      + sizeof(User::_impl_.se_)
...
GetFriendListsResponce::GetFriendListsResponce(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendListsResponce)
}
GetFriendListsResponce::GetFriendListsResponce(const GetFriendListsResponce& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GetFriendListsResponce* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void GetFriendListsResponce::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
inline void GetFriendListsResponce::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
const char* GetFriendListsResponce::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* GetFriendListsResponce::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData GetFriendListsResponce::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    GetFriendListsResponce::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*GetFriendListsResponce::GetClassData() const { return &_class_data_; }


void GetFriendListsResponce::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GetFriendListsResponce*>(&to_msg);
  auto& from = static_cast<const GetFriendListsResponce&>(from_msg);
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsResponce*
Arena::CreateMaybeMessage< ::fixbug::GetFriendListsResponce >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendListsResponce >(arena);
}
