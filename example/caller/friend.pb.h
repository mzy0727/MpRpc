...
// int32 uid = 1;
inline void GetFriendsListRequest::clear_uid() {
  uid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendsListRequest::_internal_uid() const {
  return uid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendsListRequest::uid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListRequest.uid)
  return _internal_uid();
}
inline void GetFriendsListRequest::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  uid_ = value;
}
inline void GetFriendsListRequest::set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListRequest.uid)
}
...
// bool sucess = 2;
inline void GetFriendsListResponse::clear_sucess() {
  sucess_ = false;
}
inline bool GetFriendsListResponse::_internal_sucess() const {
  return sucess_;
}
inline bool GetFriendsListResponse::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListResponse.sucess)
  return _internal_sucess();
}
inline void GetFriendsListResponse::_internal_set_sucess(bool value) {
  
  sucess_ = value;
}
inline void GetFriendsListResponse::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListResponse.sucess)
}
