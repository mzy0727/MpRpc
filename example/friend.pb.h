...
inline int32_t GetFriendsListRequest::_internal_uid() const {
  return _impl_.uid_;
}
inline int32_t GetFriendsListRequest::uid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListRequest.uid)
  return _internal_uid();
}
inline void GetFriendsListRequest::_internal_set_uid(int32_t value) {
  
  _impl_.uid_ = value;
}
inline void GetFriendsListRequest::set_uid(int32_t value) {
